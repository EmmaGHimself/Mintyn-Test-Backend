package com.mintyn.test.common.validation;

import com.mintyn.test.exception.FieldNotUniqueException;
import com.mintyn.test.exception.MissingRequiredFieldException;
